...
export declare class W3mFrameProvider {
    ...
    constructor(projectId: string, chainId?: W3mFrameTypes.Network['chainId']);
    ...
    onRpcSuccess(callback: (request: W3mFrameTypes.FrameEvent) => void): void;
    onRpcError(callback: (error: Error) => void): void;
