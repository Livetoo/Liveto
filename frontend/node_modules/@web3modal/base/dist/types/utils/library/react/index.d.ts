import type { W3mAccountButton, W3mButton, W3mConnectButton, W3mNetworkButton, W3mOnrampWidget } from '@web3modal/scaffold-ui';
...
export declare function useWeb3ModalTheme(): {
    ...
    themeVariables: import("@web3modal/core").ThemeVariables;
...
export declare function useWalletInfo(): {
    walletInfo: import("@web3modal/core").ConnectedWalletInfo;
};
export declare function useWeb3ModalState(): import("@web3modal/core").PublicStateControllerState;
