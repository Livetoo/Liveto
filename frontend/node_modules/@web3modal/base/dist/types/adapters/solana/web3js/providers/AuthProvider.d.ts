import type { AnyTransaction, Chain, Connection, GetActiveChain, Provider } from '@web3modal/scaffold-utils/solana';
import { ProviderEventEmitter } from './shared/ProviderEventEmitter.js';
import { PublicKey, type SendOptions } from '@solana/web3.js';
import { W3mFrameProvider, type W3mFrameProviderMethods as ProviderAuthMethods } from '@web3modal/wallet';
...
export declare class AuthProvider extends ProviderEventEmitter implements Provider, ProviderAuthMethods {
    ...
    readonly type = "AUTH";
    readonly auth: AuthProviderConfig['auth'];
