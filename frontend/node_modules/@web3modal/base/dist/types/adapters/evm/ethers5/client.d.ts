import type { CaipNetwork, ConnectionControllerClient, NetworkControllerClient, PublicStateControllerState, Token } from '@web3modal/core';
...
export declare class EVMEthers5Client {
    private appKit;
