...
export function mockWalletStandard() {
    ...
    return {
        accounts,
        chains: TestConstants.chains.map(chain => `solana:${chain.chainId}`),
        features: {
            'standard:connect': {
                version: '1.0.0',
            ...
            'solana:signMessage': {
                version: '1.0.0',
                signMessage: vi.fn(() => Promise.resolve([{ signedMessage: new Uint8Array(0), signature: new Uint8Array(0) }]))
            },
...
function mockAccount(account = TestConstants.accounts[0]) {
    return {
...
//# sourceMappingURL=WalletStandard.js.map