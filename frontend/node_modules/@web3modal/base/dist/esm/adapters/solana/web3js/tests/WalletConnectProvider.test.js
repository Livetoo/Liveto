...
describe('WalletConnectProvider specific tests', () => {
    ...
    it('should use the correct chain id for requests', async () => {
        await walletConnectProvider.connect();
        getActiveChain.mockImplementation(() => ({ chainId: 'EtWTRABZaYq6iMfeYKouRu166VU2xqa1' }));
    ...
    it('should replace old deprecated replacement for requests', async () => {
        vi.spyOn(provider, 'connect').mockImplementation(() => Promise.resolve(mockUniversalProviderSession({}, [
