...
export class EVMWagmiClient {
    ...
    async syncAccount({ address, isConnected, isDisconnected, chainId, connector, addresses }) {
    ...
    async syncConnectedWalletInfo(connector) {
        ...
        if (connector.id === ConstantsUtil.WALLET_CONNECT_CONNECTOR_ID && connector.getProvider) {
            ...
            this.appKit?.setConnectedWalletInfo({ name: connector.name, icon: connector.icon }, this.chain);
        }
    }
