...
export class EVMEthersClient {
    ...
    getChainId() {
        ...
        const networkControllerChainId = NetworkUtil.caipNetworkIdToNumber(this.appKit?.getCaipNetwork()?.id);
    ...
    watchEIP6963(provider) {
        ...
        const accountsChangedHandler = (accounts) => {
            ...
            if (currentAccount) {
                EthersStoreUtil.setAddress(getOriginalAddress(currentAccount));
                this.appKit?.setAllAccounts(accounts.map(address => ({ address, type: 'eoa' })), this.chain);
            }
            else {
